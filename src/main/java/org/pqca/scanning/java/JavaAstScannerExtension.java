...
public class JavaAstScannerExtension extends JavaAstScanner {
    ...
    public JavaAstScannerExtension(@Nullable SonarComponents sonarComponents) {
    ...
    public void simpleScan(
        ...
        try {
            ...
            if (inputFile
                    ...
                    .getAbsolutePath()
                    .endsWith(
                            "spring-boot-project/spring-boot-tools/spring-boot-buildpack-platform/src/main/java/org/springframework/boot/buildpack/platform/docker/type/Layer.java")) {
